...
const API = `${process.env.NEXT_PUBLIC_API_URL}/api/product-types`;
...
export default function ManageProductTypes() {
  ...
  const handleAdd = async () => {
    if (!name.trim()) return toast.error("Enter product type name");
                ...
                <div className="p-6 space-y-4">
                  ...
                  >
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      Deleting this product type will affect all products associated with it. Make sure you want to proceed.
                    </p>
                  </motion.div>
    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      >
        ...
        <p className="text-sm text-black/50 mt-1">
          Add, edit, or remove product types (e.g., Bat, Ball, Gloves, Pads)
        </p>
      </motion.div>
      ...
      >
        <input
          ...
          placeholder="Enter product type name (e.g., Bat, Ball)"
          className="
            flex-1
            ...
            >
              {editingId === type._id ? (
                <input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && handleUpdate(type._id)}
                  className="
                    flex-1
              ...
              <div className="flex gap-2">
                {editingId === type._id ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={() => openDeleteModal(type._id, type.name)}
                      className="
                        cursor-pointer
                        p-2 rounded-lg
        ...
        {productTypes.length === 0 && (
          ...
          >
            <p className="text-sm text-black/50">
              No product types yet. Add your first product type above!
            </p>
          </motion.div>
        )}
      </motion.div>
